...
# ==============================================================================
                ...
                # IMPLEMENTATION
                # ---- start your code ---- #
                ind_msg = text_proc(meg['message'], from_name)
                self.indices[from_name].add_msg_and_index(ind_msg)
                ...
                for g in the_guys:
                    ...
                    # IMPLEMENTATION
                    # ---- start your code ---- #
                    self.indices[g].add_msg_and_index(ind_msg)
                    # mysend(
...
# ==============================================================================
                ...
                num = msg['target']
                from_name = self.logged_sock2name[from_sock]
                for i in self.indices[from_name].search(num):
                    search_rslt + i[-1]
                    search_rslt + '\n'
